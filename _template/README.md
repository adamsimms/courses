...
- **Credits:** X-credit course
- **Length:** X weeks / X semesters
- **Time:** Day, start–end
- **Location:** Room SGW
...
**Photography department fee:** All students must pay $XX for each X-credit course. Please pay online via [Concordia Fine Arts fees](https://www.concordia.ca/cunews/finearts/digital-arts/fine-arts-fees.html) and email the receipt to the professor by **Week 4**. The names of students who have yet to pay by this date are given to the technicians, and students will only be able to access the labs or borrow equipment once the fees are paid.
