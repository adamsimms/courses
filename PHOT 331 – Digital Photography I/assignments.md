...
- Scan 1 colour negative or positive using an Imacon Flextight scanner to produce an image file of 20×30 inches at 300 PPI.
- Scan 1 colour negative, positive, OR reflective print using an Epson flatbed scanner to produce an image file of 16×20 inches at 300 PPI.
- Convert 1 digital RAW file to produce an image of 8×10 inches at 300 PPI.
...
Send your layered files via [WeTransfer](https://wetransfer.com/) to the instructor.
...
Send your layered files via [WeTransfer](https://wetransfer.com/) to the instructor and bring your physical prints to class.
...
- Example: `adam-simms-trees-16x20.psd`
- Send your layered files via [WeTransfer](https://wetransfer.com/) to the instructor and bring your physical prints to class on your presentation day.
